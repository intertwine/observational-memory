...
Observational Memory is user-level memory for Claude Code, Codex, OpenCode, Kimi Code CLI, Grok Build TUI, Cowork, and Hermes.
...
- `src/observational_memory/transcripts/`: Claude, Codex, OpenCode, Kimi, Grok, Cowork, Hermes, and Claude auto-memory parsers.
...
- Kimi Code CLI: hooks for startup context plus prompt/subagent checkpoints captured from lifecycle JSON.
